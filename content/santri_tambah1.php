...
<!--                        <h3 class="box-title">Quick Example</h3>-->
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="?hal=santri_insert1" method="post" role="form">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-success"><href="?hal=santri_tampil1">Simpan</button>
                            <button type="reset" class="btn btn-warning">Reset</button>
                            <a class="btn btn-danger" href="?hal=santri_tampil1">Batal</a>
                        </div>
