...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/portfolio/portfolio-8.jpg" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="index.html"><b>MKS</b><span></span></a></h1>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-stretch">
            <div class="content">
              <h3>Manajemen Koperasi Sekolah</h3>
              <p>Koperasi sekolah merupakan salah satu koperasi yang dibentuk di lingkungan sekolah, baik lembaga 
                pendidikan formal dan non-formal, di mana anggotanya adalah siswa di sekolah.</p>
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <h4>Mengurangi Penggunaan Kertas</h4>
                  <p>Paperless adalah upaya untuk mengurangi penggunaan kertas di suatu tempat, seperti di rumah, kantor, atau sekolah. Caranya adalah dengan mengubah kertas dan arsip lainnya ke bentuk digital alias arsip digital. Proses ini, disebut juga dengan digitisasi.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Memudahkan Pendataan Koperasi Sekolah</h4>
                  <p>merupakan suatu proses pencatatan keterangan yang benar dan nyata tentang sesuatu, baik manusia, benda, lingkungan, maupun kejadian tertentu. Pencatatan ini dimaksudkan sebagai suatu dokumentasi atau arsip yang dapat digunakan untuk suatu keperluan di masa depan.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                  <i class="bx bx-images"></i>
                  <h4>Mengembangkan sistem informasi Koperasi Sekolah Berbasis Website</h4>
                  <p>Koperasi sebagai salah satu pelaku kegiatan ekonomi di Indonesia harus
                     mentransformasi kegiatan operasional dan manajemen mengikuti perkembangan teknologi
